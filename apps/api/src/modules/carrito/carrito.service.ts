...
export class CarritoService {
  ...
  async create(dto: CreateCarritoItemDto) { return serializeBigInts(await this.prisma.carrito_item.create({ data: { id_usuario: String(dto.id_usuario), id_producto: toBigIntId(dto.id_producto), cantidad: dto.cantidad, precio_unitario_snapshot: dto.precio_unitario_snapshot, moneda_snapshot: dto.moneda_snapshot ?? 'MXN' } })); }
