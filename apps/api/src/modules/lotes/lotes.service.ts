...
export class LotesService {
  ...
  async findByProductor(id_productor: number) { return serializeBigInts(await this.prisma.lotes.findMany({ where: { id_productor, eliminado_en: null }, include: { lote_atributos: true, productores: true, regiones: true } })); }
