        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          <div>
            ...
            {productores.length === 0 && (
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-2 text-sm text-amber-700 mb-2">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none disabled:bg-gray-100 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"
            >
              <option key="" value="">
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-gray-50"
            >
              Cancelar
            </button>
            <button
