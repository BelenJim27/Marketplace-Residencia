...
// ─── HOOK: detecta dark mode por clase en <html> o por preferencia del sistema ─
...
const TEXT_COLORS = {
  light: { dark: "#1A241E", mid: "#5C6B5E", italic: "#3c1c08", annotation: "#5c2a0a" },
  dark:  { dark: "#F0EDE4", mid: "#C8D4C8", italic: "#E8C07A", annotation: "#E8C07A" },
};
    ...
    >
      ...
      <div style={{ position: "relative", height: "65vh", minHeight: "420px", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          justifyContent: "flex-end", padding: "48px 56px", maxWidth: "600px",
        }}>
          ...
          <h1 style={{ fontFamily: "Georgia, serif", fontSize: "46px", fontWeight: 700, lineHeight: 1.2, margin: "0 0 14px", color: "#fff" }}>
            {t("Oaxaca auténtico,")}<br />{t("trazable y justo")}
          </h1>
          <p style={{ fontSize: "15px", lineHeight: 1.7, opacity: 0.85, maxWidth: "360px", margin: "0 0 20px", color: "#fff" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ── Cita final ── siempre dorado, legible en ambos modos */}
          <p style={{
        ...
        <div style={{
          ...
          gridTemplateRows: "1fr 1fr", gap: "6px", padding: "16px", alignItems: "stretch",
        }}>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "40px", opacity: prodVisible ? 1 : 0, transition: "opacity 0.3s" }}>
          <h2 style={{
            fontFamily: "Georgia, serif", fontSize: "38px", fontWeight: 700,
            ...
            {producto.anotaciones.map((a, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: "12px", maxWidth: "260px" }}>
                <p style={{
                  ...
                  color: C.annotation,   /* ← antes #5c2a0a, invisible en dark */
        ...
        {(["left", "right"] as const).map((dir) => (
          <button key={dir} onClick={() => handleProdGo(dir === "left" ? prodActual - 1 : prodActual + 1)} style={{
            ...
            [dir]: "16px", zIndex: 20, width: "36px", height: "36px", borderRadius: "50%",
      ...
      <div style={{
        background: "var(--land-bg-white, #fff)",
        borderTop: "1px solid var(--land-border, #E5E5E1)",
        marginTop: "10px", padding: "48px 28px",
        display: "flex", flexDirection: "column", alignItems: "center",
      }}>
        {/* ── Encabezado ── */}
        <p style={{ fontSize: "13px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#C8A97A", marginBottom: "28px" }}>
        ...
        <div style={{ display: "flex", gap: "36px", alignItems: "center", justifyContent: "center", width: "100%", maxWidth: "960px" }}>
          <div style={{
            ...
            <img src={slide.imagen} alt={`Slide ${slideActual + 1}`} style={{ width: "100%", height: "100%", objectFit: "cover", opacity: slideVisible ? 1 : 0, transition: "opacity 0.3s" }} />
          ...
          <div style={{ display: "flex", gap: "28px", justifyContent: "center", flex: 1 }}>
            {slide.circulos.map((item, i) => (
              <div key={`${slideActual}-${i}`} style={{
                ...
                {item.etiqueta && (
                  <p style={{
                    fontSize: "13px", fontStyle: "italic", textAlign: "center",
                    fontFamily: "Georgia, serif",
                    color: C.mid,  /* ← antes #5C6B5E, invisible en dark */
                    maxWidth: "100px", margin: 0,
                  }}>
                    {t(item.etiqueta)}
                  </p>
                )}
      ...
      <div ref={statsRef} style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <p style={{ fontSize: "22px", fontWeight: 700, color: C.dark, fontFamily: "Georgia, serif", margin: 0, marginBottom: "10px" }}>
            {t("Impacto que construimos juntos")}
          </p>
          <p style={{ fontSize: "15px", color: C.mid, fontStyle: "italic", fontFamily: "Georgia, serif", margin: 0 }}>
          ...
          {STATS_CONFIG.map((stat, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                gap: "12px", padding: "22px 16px", borderRadius: "14px",
                ...
                <div>
                  <p style={{ fontSize: "26px", fontWeight: 700, color: C.dark, fontFamily: "Georgia, serif", margin: 0, lineHeight: 1.1 }}>
                    {statsLoading ? "…" : valor}
                  </p>
                  <p style={{ fontSize: "13px", lineHeight: 1.4, color: C.mid, margin: 0, marginTop: "5px" }}>
                    {t(stat.label)}
                  </p>
                </div>
              </div>
      ...
      {/* ══════════════════════════════════════════════════
          BLOQUE 4 — FOOTER (siempre oscuro, sin cambios, NO se toca)
      ══════════════════════════════════════════════════ */}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "28px", maxWidth: "960px", margin: "0 auto" }}>
          ...
          <div>
            ...
            {["Maestras mezcaleras", "Historia", "Nuestro proceso"].map((item) => (
              <a key={item} href="#" style={{ display: "block", fontSize: "13px", opacity: 0.65, color: "#D1D5D2", textDecoration: "none", marginBottom: "6px" }}>
                {t(item)}
              </a>
            ))}
          </div>
          <div>
            ...
            {["guardianasdemezcal@gmail.com", "9512578906", "Santa Maria Zaquilán, Oaxaca"].map((item) => (
              <p key={item} style={{ fontSize: "13px", opacity: 0.65, color: "#D1D5D2", margin: 0, marginBottom: "6px" }}>{t(item)}</p>
            ))}
          </div>
        </div>
