          ...
          {productos.map((producto, index) => {
            ...
            return (
              ...
              >
                {/* ─── Imagen ─── */}
                <div
                  className="relative flex-shrink-0 h-80 w-80 overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 cursor-pointer"
