...
import { ShoppingCart, Search, X, SlidersHorizontal, ChevronDown } from "lucide-react";
...
export default function ProductCatalogPublic() {
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {productos.map((producto) => (
            ...
            >
              <button
                onClick={() => router.push(`/producto/${producto.id_producto}`)}
