...
-- CreateIndex
CREATE INDEX "idx_almacenes_ubicacion" ON "almacenes" USING GIN ("ubicacion" jsonb_ops ASC);

-- CreateIndex
CREATE INDEX "idx_archivos_entidad" ON "archivos"("entidad_tipo" ASC, "entidad_id" ASC);

-- CreateIndex
CREATE INDEX "idx_auditoria_fecha" ON "auditoria"("fecha" ASC);

-- CreateIndex
CREATE INDEX "idx_auditoria_usuario" ON "auditoria"("id_usuario" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "carrito_item_id_usuario_id_producto_key" ON "carrito_item"("id_usuario" ASC, "id_producto" ASC);

-- CreateIndex
CREATE INDEX "idx_carrito_producto" ON "carrito_item"("id_producto" ASC);

-- CreateIndex
CREATE INDEX "idx_carrito_usuario" ON "carrito_item"("id_usuario" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "categorias_slug_key" ON "categorias"("slug" ASC);

-- CreateIndex
CREATE INDEX "idx_cat_padre" ON "categorias"("id_padre" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "configuracion_sistema_clave_key" ON "configuracion_sistema"("clave" ASC);

-- CreateIndex
CREATE INDEX "idx_direcciones_ubicacion" ON "direcciones" USING GIN ("ubicacion" jsonb_ops ASC);

-- CreateIndex
CREATE INDEX "idx_envio_eventos_guia" ON "envio_eventos"("id_guia" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "envio_guias_numero_guia_key" ON "envio_guias"("numero_guia" ASC);

-- CreateIndex
CREATE INDEX "idx_envios_estado" ON "envios"("estado" ASC);

-- CreateIndex
CREATE INDEX "idx_envios_pedido" ON "envios"("id_pedido" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "integraciones_envio_id_transportista_entorno_key" ON "integraciones_envio"("id_transportista" ASC, "entorno" ASC);

-- CreateIndex
CREATE INDEX "idx_inventario_almacen" ON "inventario"("id_almacen" ASC);

-- CreateIndex
CREATE INDEX "idx_inventario_producto" ON "inventario"("id_producto" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "inventario_id_producto_id_almacen_key" ON "inventario"("id_producto" ASC, "id_almacen" ASC);

-- CreateIndex
CREATE INDEX "idx_lote_atributos_lote" ON "lote_atributos"("id_lote" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "lote_atributos_id_lote_clave_key" ON "lote_atributos"("id_lote" ASC, "clave" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "lotes_codigo_lote_key" ON "lotes"("codigo_lote" ASC);

-- CreateIndex
CREATE INDEX "idx_movimientos_creado_en" ON "movimientos_inventario"("creado_en" ASC);

-- CreateIndex
CREATE INDEX "idx_movimientos_inventario" ON "movimientos_inventario"("id_inventario" ASC);

-- CreateIndex
CREATE INDEX "idx_movimientos_pedido" ON "movimientos_inventario"("id_pedido" ASC);

-- CreateIndex
CREATE INDEX "idx_notificaciones_usuario_leido" ON "notificaciones"("id_usuario" ASC, "leido" ASC);

-- CreateIndex
CREATE INDEX "idx_pagos_estado" ON "pagos"("estado" ASC);

-- CreateIndex
CREATE INDEX "idx_pagos_pedido" ON "pagos"("id_pedido" ASC);

-- CreateIndex
CREATE INDEX "idx_prt_usuario" ON "password_reset_tokens"("id_usuario" ASC);
...
-- CreateIndex
CREATE INDEX "idx_pedidos_usuario" ON "pedidos"("id_usuario" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "permisos_nombre_key" ON "permisos"("nombre" ASC);

-- CreateIndex
CREATE INDEX "idx_prod_cat_categoria" ON "producto_categoria"("id_categoria" ASC);

-- CreateIndex
CREATE INDEX "idx_producto_imagenes_producto" ON "producto_imagenes"("id_producto" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "productores_id_usuario_key" ON "productores"("id_usuario" ASC);

-- CreateIndex
CREATE INDEX "idx_productos_metadata" ON "productos" USING GIN ("metadata" jsonb_ops ASC);

-- CreateIndex
CREATE INDEX "idx_productos_status" ON "productos"("status" ASC);

-- CreateIndex
CREATE INDEX "idx_productos_tienda" ON "productos"("id_tienda" ASC);

-- CreateIndex
CREATE INDEX "idx_productos_traducciones" ON "productos" USING GIN ("traducciones" jsonb_ops ASC);

-- CreateIndex
CREATE UNIQUE INDEX "refresh_tokens_token_hash_key" ON "refresh_tokens"("token_hash" ASC);

-- CreateIndex
CREATE INDEX "idx_resenas_producto" ON "resenas"("id_producto" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "resenas_id_usuario_id_producto_key" ON "resenas"("id_usuario" ASC, "id_producto" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "roles_nombre_key" ON "roles"("nombre" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "servicios_envio_id_transportista_codigo_servicio_key" ON "servicios_envio"("id_transportista" ASC, "codigo_servicio" ASC);

-- CreateIndex
CREATE INDEX "idx_tasas_categoria" ON "tasas_impuesto"("id_categoria" ASC);

-- CreateIndex
CREATE INDEX "idx_tiendas_productor" ON "tiendas"("id_productor" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "transportistas_codigo_key" ON "transportistas"("codigo" ASC);
